...
const CreateContainer = () => {
  ...
  return (
    <div className="w-full min-h-screen flex items-center justify-center">
      <div
        className="w-[90%] md:w-[50%] border border-gray-300 rounded-lg 
      ...
      >
               ...
               justify-center gap-2"
                  ...
                  <>
                    <div className="relative">
                      ...
                      <button
                        type="button"
                        className="absolute -bottom-3 -right-2 md:-bottom-20 p-3 rounded-full 
        ...
        <div className="w-full flex flex-col md:flex-row items-center gap-3">
          ...
          >
            ...
            bg-transparent placeholder:text-gray-400 text-textColor"
            />
          </div>
        </div>
        ...
        <div className="flex items-center w-full">
          <button
            ...
            bg-emerald-600 px-12 py-2 rounded-lg text-lg text-white font-semibold"
            onClick={saveDetails}
          >
            Save
          </button>
